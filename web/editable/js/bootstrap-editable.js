...
(function ($) {
    ...
    $.fn.editableform.template = '<form class="form-inline editableform" onsubmit="return false;">' +
        ...
        '<div class="control-group" style="width:100%;display:block;">' + // 【変更】style追加
        '<div><div class="editable-input" style="width:100%;display:block;"></div><div class="editable-buttons"></div></div>' + // 【変更】style追加
...
(function ($) {
    ...
    Text.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
         ...
         **/
        tpl: '<input type="text" style="width:100%;">', // 【変更】style追加
        /**
...
(function ($) {
    ...
    Textarea.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
         ...
         **/
        tpl: '<textarea style="width:100%;"></textarea>', // 【変更】style追加
        /**
         @property inputclass
         @default input-large
         **/
