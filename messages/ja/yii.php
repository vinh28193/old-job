...
return [
    ...
    '{attribute} cannot be blank.' => '{attribute}は必須項目です。',
    '{attribute} is invalid.' => '{attribute}は無効です。',
    '{attribute} is not a valid URL.' => '{attribute}は有効な URL 書式ではありません。',
    '{attribute} is not a valid email address.' => '正しいメールアドレス表記で入力してください。',
    ...
    '{attribute} must be greater than or equal to "{compareValueOrAttribute}".' => '{attribute}は"{compareValueOrAttribute}"以上である必要があります。',
    ...
    '{attribute} must be no greater than {max}.' => '{attribute}は"{max}"以下の数字で入力してください。',
    '{attribute} must be no less than {min}.' => '{attribute}は"{min}"以上の数字で入力してください。',
    ...
    '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => '{attribute}は{max}文字以下で入力してください。',
