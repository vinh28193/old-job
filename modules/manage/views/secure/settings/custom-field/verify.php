...
<div class="custom-field-csv">
        <?php echo Html::tag('h1', bootstrapHtml::icon($menu->icon_key) . Html::encode($this->title), ['class' => 'heading']) ?>
        ...
        <div class="col-md-10" role="complementary">
            ...
            echo Html::tag('span', 0, ['class' => 'progress-count']) . '/' . Html::tag('span', 0,
                    ['class' => 'total-count']) . Html::tag('span', Yii::t('app', 'アップロードされたCSVをチェックしています...'),
                    ['style' => Html::cssStyleFromArray(['margin' => '0px 10px'])]);
            ?>
            <?= Html::a(Yii::t('app', '戻る'), Url::to(['csv']), [
                'class' => 'btn btn-default center-block',
                'style' => Html::cssStyleFromArray(['width' => '30%', 'margin' => '10px auto'])
            ]) ?>
