...
use app\modules\manage\controllers\secure\JobCsvController;
...
$tooManyErrorMessage = Yii::t("app", "読み込みエラーが" . JobCsvController::ERROR_LIMIT_COUNT . "件を超えているため、読み込みを停止しました。CSVの内容をご確認の上、アップロードを再度行ってください。");
...
$exceptionErrorMessage = Yii::t("app", "例外が発生したため、CSVの検証を停止しました。");
