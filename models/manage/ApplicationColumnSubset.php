...
/**
 * This is the model class for table "application_column_subset".
 *
 * @property integer $id
 ...
 */
class ApplicationColumnSubset extends BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'application_column_subset';
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'column_name' => Yii::t('app', 'application_masterのカラム名'),
