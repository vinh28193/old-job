...
/**
 * Class m160301_041546_create_client_column_set
 * function_item_setのclient部分を分離・解体したテーブルを作る
 */
class m160301_041546_create_client_column_set extends Migration
{
    const TABLE_NAME = 'client_column_set';
    const MANAGE_MENU_ID = 7;
    const RECORD_PAR_TENANT = 19;
    const MASTER_TABLE = 'client_master';
    const FUNCTION_NAME = '掲載企業';
