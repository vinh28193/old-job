...
/**
 * Class m160301_041451_create_admin_column_set
 * function_item_setのadmin_master部分を分離・解体したテーブルを作る
 */
class m160301_041451_create_admin_column_set extends Migration
{
    const TABLE_NAME = 'admin_column_set';
    const MANAGE_MENU_ID = 1;
    const RECORD_PAR_TENANT = 19;
    const MASTER_TABLE = 'admin_master';
    const FUNCTION_NAME = '管理者';
